...
if (service.indexOf("keysToUnbind") < 0)
  fail("Service.qml must re-read live binds before unbind")
if (service.indexOf("cannotRestoreTiled") < 0)
  fail("Service.qml must refuse cloak when tiled marked windows cannot restore losslessly")
